			...
			<form>
				<div class="field">
					...
					<span
						v-if="
							!$v.selected.required &&
								(this.$v.selected.$dirty || !validated)
						"
				...
				<div class="field">
					...
					<div
						v-if="
							this.$v.TutoringOffer.Capacity.$dirty || !validated
						"
					>
						<span v-if="!$v.TutoringOffer.Capacity.required"
							>Este campo es obligatorio</span
						>
						<span v-if="!$v.TutoringOffer.Capacity.checkCapacity"
							>La capacidad maxima es 5</span
						>
					</div>
				</div>
				...
				<div class="field">
					...
					<span
						v-if="
							!$v.TutoringOffer.Description.required &&
...
export default Vue.extend({
	...
	async created() {
		...
		let courses: Array<
			Course
		> = await offerService.findAllCoursesByUniversity(
